...
namespace SquareFillDomain.Utils
{
    ...
    {    
        ...
        // private func RoundDimensionDownToMultipleOfSquareWidth(screenDimension: Int) -> Int 
        ...
        // public static var TopLeftGridSquare = SquareFillPoint(
        public static SquareFillPoint TopLeftGridSquare = SquareFillPoint(
            x: ContainingRectangle.X,
            y: ContainingRectangle.Y);

        // public static let RightHydrantPoints: [SquareFillPoint] = [SquareFillPoint(x: 0, y: 0), SquareFillPoint(x: 0, y: 1), SquareFillPoint(x: 0, y: 2), SquareFillPoint(x: 1, y: 1)];
